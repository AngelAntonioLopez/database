...
CREATE TABLE `order_db` (
  ...
  KEY `fk_order_db_user_db1_idx` (`order_client`),
  KEY `fk_order_db_address_db1_idx` (`order_address`),
  CONSTRAINT `fk_order_db_address_db1` FOREIGN KEY (`order_address`) REFERENCES `address_db` (`id_address`),
  CONSTRAINT `fk_order_db_user_db1` FOREIGN KEY (`order_client`) REFERENCES `user_db` (`id_user`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `order_details_db`
--

DROP TABLE IF EXISTS `order_details_db`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `order_details_db` (
  `id_details` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id_details`),
  KEY `fk_bill_details_db_bill_db1_idx` (`details_order`),
  KEY `fk_bill_details_db_product_db1_idx` (`details_product`),
  CONSTRAINT `order_to_details` FOREIGN KEY (`details_order`) REFERENCES `order_db` (`id_order`) ON UPDATE RESTRICT,
  CONSTRAINT `order_to_product` FOREIGN KEY (`details_product`) REFERENCES `product_db` (`id_product`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `order_details_db`
--

LOCK TABLES `order_details_db` WRITE;
/*!40000 ALTER TABLE `order_details_db` DISABLE KEYS */;
/*!40000 ALTER TABLE `order_details_db` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-06-02 19:52:18
